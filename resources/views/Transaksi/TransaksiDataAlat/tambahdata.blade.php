        ...
        <div class="table-responsive">
          ...
          <form method="POST" action="{{route('simpantransaksialat')}}" >
            ...
            <tbody>
              <tr>
                <td>
                  <select name="addMoreInputFields[0][nama_alat]" data-index="0" id="nama_alat" class="form-control nama_alat" >
