            ...
            <form method="POST" action="{{route('simpanmakanan')}}" enctype="multipart/form-data" >
              ...
              {{-- <table class="table table-bordered" id="dynamicAddRemove">
                ...
                <tr>
                    ...
                    <td>
                      <input type="text" id="addMoreInputFields[0][nama_makanan]" name="nama_makanan" class="form-control" placeholder="Makanan" required="">
                    </td>
                    <td>
